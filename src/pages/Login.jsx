    ...
    try {
        if (mode === 'login') {
            ...
            await axios.post('http://127.0.0.1:8000/api/signup', {
                ...
                password: formData.password,
                role: role,
                qc_id: role === 'Seeker' ? formData.qcId : null,
                industry: role === 'Employer' ? formData.industry : null
            });
        ...
        // KUNIN ANG ERROR GALING LARAVEL
        const message = error.response?.data?.message || "Connection error. Is Laravel running?";
